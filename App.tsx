  ...
  return (
      ...
      {selectedProject ? (
        ...
        <div className="flex flex-col">
          ...
          {/* Bio Section */}
          <section id="bio" className="py-24 px-6 relative z-10 bg-white/40 dark:bg-sage-900/10 border-y border-sage-200/30 dark:border-white/5">
            <div className="max-w-4xl mx-auto text-center space-y-8">
              <span className="text-sage-400 dark:text-sage-500 font-black tracking-[0.8em] uppercase text-[10px] block">{t.bio}</span>
